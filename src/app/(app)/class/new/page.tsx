    ...
    <div className="mx-auto flex max-w-sm flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted text-sm">
          Une classe rassemble plusieurs cours (une promo, un centre de formation…). Tu en deviens
          administrateur et tu pourras y créer des cours. Ceux qui rejoignent la classe avec son
          code ont accès à tous ses cours.
        </p>
      </div>
      <CreateClassForm />
    </div>
